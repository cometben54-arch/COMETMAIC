export const settingsZhCN = {
  settings: {
    ...
    ragSettings: 'RAG 知识库',
    ragTitle: 'RAG 知识库管理',
    ragDescription: '上传文档建立本地知识库，让 AI 基于你的资料生成课程，减少幻觉，提高准确性。',
    ragUploadButton: '上传文档',
    ragUploadHint: '支持 PDF、TXT、MD 格式，单个文件最大 20MB',
    ragFileList: '已上传文档',
    ragNoFiles: '暂无文档，请上传文档建立知识库',
    ragProcessing: '处理中...',
    ragProcessed: '已就绪',
    ragFailed: '处理失败',
    ragDeleteConfirm: '确定要删除此文档吗？',
    ragDeleteSuccess: '文档已删除',
    ragUploadSuccess: '文档上传成功，正在处理...',
    ragUploadFailed: '上传失败，请重试',
    ragEnabled: '启用 RAG 知识库',
    ragEnabledDesc: '启用后，AI 将优先参考知识库中的文档内容来生成课程',
    ragChunks: '个片段',
    ragClearAll: '清空所有文档',
    ragClearConfirm: '确定要清空所有已上传的文档吗？此操作不可撤销。',
  },
  profile: {
    title: '个人资料',
    defaultNickname: '同学',
...
export const settingsEnUS = {
  settings: {
    ...
    optional: 'Optional',
    // RAG Knowledge Base settings
    ragSettings: 'RAG Knowledge Base',
    ragTitle: 'RAG Knowledge Base',
    ragDescription: 'Upload documents to build a local knowledge base. AI will generate courses based on your materials, reducing hallucinations and improving accuracy.',
    ragUploadButton: 'Upload Document',
    ragUploadHint: 'Supports PDF, TXT, MD formats. Max 20MB per file.',
    ragFileList: 'Uploaded Documents',
    ragNoFiles: 'No documents yet. Upload documents to build your knowledge base.',
    ragProcessing: 'Processing...',
    ragProcessed: 'Ready',
    ragFailed: 'Processing failed',
    ragDeleteConfirm: 'Are you sure you want to delete this document?',
    ragDeleteSuccess: 'Document deleted',
    ragUploadSuccess: 'Document uploaded, processing...',
    ragUploadFailed: 'Upload failed, please try again',
    ragEnabled: 'Enable RAG Knowledge Base',
    ragEnabledDesc: 'When enabled, AI will prioritize knowledge base content for course generation',
    ragChunks: 'chunks',
    ragClearAll: 'Clear All Documents',
    ragClearConfirm: 'Are you sure you want to clear all uploaded documents? This cannot be undone.',
  },
  profile: {
    title: 'Profile',
