...
export const TTS_PROVIDERS: Record<TTSProviderId, TTSProviderConfig> = {
  ...
  'minimax-tts': {
    ...
    voices: [
      { id: 'male-qn-qingse', name: '青涩青年男声', language: 'zh-CN', gender: 'male', description: '最常用默认男声' },
      { id: 'male-qn-jingying', name: '精英青年男声', language: 'zh-CN', gender: 'male', description: '精英感男声' },
      { id: 'male-qn-badao', name: '霸道青年男声', language: 'zh-CN', gender: 'male', description: '霸道感男声' },
      { id: 'male-qn-daxuesheng', name: '青年大学生男声', language: 'zh-CN', gender: 'male', description: '大学生男声' },
      { id: 'presenter_male', name: '男性主持人', language: 'zh-CN', gender: 'male', description: '播音主持风格' },
      { id: 'audiobook_male_1', name: '男性有声书1', language: 'zh-CN', gender: 'male', description: '有声书风格' },
      { id: 'audiobook_male_2', name: '男性有声书2', language: 'zh-CN', gender: 'male', description: '有声书风格' },
      { id: 'male-qn-qingse-jingpin', name: '青涩青年男声-beta', language: 'zh-CN', gender: 'male', description: '精品版青涩男声' },
      { id: 'male-qn-jingying-jingpin', name: '精英青年男声-beta', language: 'zh-CN', gender: 'male', description: '精品版精英男声' },
      { id: 'male-qn-badao-jingpin', name: '霸道青年男声-beta', language: 'zh-CN', gender: 'male', description: '精品版霸道男声' },
      { id: 'male-qn-daxuesheng-jingpin', name: '青年大学生男声-beta', language: 'zh-CN', gender: 'male', description: '精品版大学生男声' },
      { id: 'female-shaonv', name: '少女音色', language: 'zh-CN', gender: 'female', description: '清甜少女音' },
      { id: 'female-yujie', name: '御姐音色', language: 'zh-CN', gender: 'female', description: '成熟御姐音' },
      { id: 'female-chengshu', name: '成熟女性音色', language: 'zh-CN', gender: 'female', description: '成熟女性音' },
      { id: 'female-tianmei', name: '甜美女性音色', language: 'zh-CN', gender: 'female', description: '甜美女声' },
      { id: 'presenter_female', name: '女性主持人', language: 'zh-CN', gender: 'female', description: '播音主持风格' },
      { id: 'audiobook_female_1', name: '女性有声书1', language: 'zh-CN', gender: 'female', description: '有声书风格' },
      { id: 'audiobook_female_2', name: '女性有声书2', language: 'zh-CN', gender: 'female', description: '有声书风格' },
      { id: 'female-shaonv-jingpin', name: '少女音色-beta', language: 'zh-CN', gender: 'female', description: '精品版少女音' },
      { id: 'female-yujie-jingpin', name: '御姐音色-beta', language: 'zh-CN', gender: 'female', description: '精品版御姐音' },
      { id: 'female-chengshu-jingpin', name: '成熟女性音色-beta', language: 'zh-CN', gender: 'female', description: '精品版成熟女声' },
      { id: 'female-tianmei-jingpin', name: '甜美女性音色-beta', language: 'zh-CN', gender: 'female', description: '精品版甜美女声' },
      { id: 'clever_boy', name: 'Clever Boy (EN)', language: 'en-US', gender: 'male', description: 'Smart young male (English)' },
      { id: 'cute_boy', name: 'Cute Boy (EN)', language: 'en-US', gender: 'male', description: 'Cute boy voice (English)' },
      { id: 'lovely_girl', name: 'Lovely Girl (EN)', language: 'en-US', gender: 'female', description: 'Lovely girl voice (English)' },
      { id: 'cartoon_pig', name: 'Cartoon Pig (EN)', language: 'en-US', gender: 'neutral', description: 'Cartoon character (English)' },
    ],
